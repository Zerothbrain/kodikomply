...
const DownloadCTA = () => {
  return (
    <section className="py-20 lg:py-28 bg-gradient-to-br from-primary via-primary to-tz-blue relative overflow-hidden z-10">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        <AnimatedSection className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" variant="secondary" className="gap-2 text-lg px-10 py-6 font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
